...
class Parser:
    ...
    def __str__(self) -> str:
        return f"Parsed: {self.parsed}, Iteration: {self.current}"
...
class Program:
    #implement parse: import, global_dec, func_def

    def __init__(self,imp, glob_dec, func_def_pre, sheesh_dec, func_def_post ) -> None:
        self.imp=imp
...
class Import:
    ...
    def __init__(self, import_prog, import_next, more_import) -> None:
        self.use="use"
